...
xaxis = [10:1:20]; %number of datapoints
yaxis = [0:2:20]; %noise levels
n_generations = 1;
...
for generation = 1:n_generations
    for noise = yaxis
        ...
        %% generate data
        [var,t,x_noisy,dx] = generatedata_random3(noise,num_data_points,1,1);
