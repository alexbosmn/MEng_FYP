function [var,time, data_noisy, dx] = generatedata_random2(noise,num_data_points,beta_orig,gamma_orig)
...
%     num_data_points = ;
    ...
    [T X]=ode45(@(t,x)toggleswitch_params2(t,x,beta_orig,gamma_orig),tspan,initial);
    ...
    for i = 1:length(data_noisy)
        dx(i,:) = toggleswitch_params2(time(i),data_noisy(i,:),beta_orig,gamma_orig);
    end
